...
export function WorkspaceCard({
    ...
    return (
        <article
            className={cn(
                "group/card relative min-h-49 overflow-hidden rounded-3xl shadow-sm transition-all hover:-translate-y-0.5 hover:shadow-lg",
                className,
            )}
        >
            <Link
            ...
            <div className="pointer-events-none relative flex h-full min-h-49 flex-col p-5">
